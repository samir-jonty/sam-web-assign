...
class OwlCarousel2RevisionRevertForm extends ConfirmFormBase {
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity_type.manager')->getStorage('owlcarousel2'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')
      ->notice('OwlCarousel2: reverted %title revision %revision.',
        [
    ...
    $this->messenger()
      ->addMessage($this->t(
        'OwlCarousel2 %title has been reverted to the revision from %revision-date.',
        [
          '%title' => $this->revision->label(),
