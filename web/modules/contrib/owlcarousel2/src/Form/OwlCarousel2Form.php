...
class OwlCarousel2Form extends ContentEntityForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['settings']['slide_options']['items_per_slide'] = [
      ...
      '#min' => 1,
      '#max' => 10,
      '#default_value' => $settings['items_per_slide'] ?? 1,
    ];
    ...
    $form['settings']['slide_options']['margin'] = [
      ...
      '#min' => 0,
      '#max' => 1000,
      '#default_value' => $settings['margin'] ?? 1,
    ];
    ...
    $form['settings']['slide_options']['stagePadding'] = [
      ...
      '#min' => 0,
      '#max' => 1000,
      '#default_value' => $settings['stagePadding'] ?? 0,
    ];
    ...
    $form['settings']['slide_options']['center'] = [
      ...
      '#default_value' => $settings['center'] ?? 'true',
    ];
    ...
    $form['settings']['slide_options']['loop'] = [
      ...
      '#default_value' => $settings['loop'] ?? 'true',
    ];
    ...
    $form['settings']['slide_options']['autoplay'] = [
      ...
      '#default_value' => $settings['autoplay'] ?? 'yes',
    ];
    ...
    $form['settings']['slide_options']['autoplayHoverPause'] = [
      ...
      '#default_value' => $settings['autoplayHoverPause'] ?? 'yes',
    ];
    ...
    $form['settings']['slide_options']['autoplaySpeed'] = [
      ...
      '#min' => 1,
      '#max' => 100000,
      '#default_value' => $settings['autoplaySpeed'] ?? 2000,
    ];
    ...
    $form['settings']['slide_options']['autoplayTimeout'] = [
      ...
      '#min' => 1,
      '#max' => 100000,
      '#default_value' => $settings['autoplayTimeout'] ?? 5000,
    ];
    ...
    $form['settings']['navigation_options']['nav'] = [
      ...
      '#default_value' => $settings['nav'] ?? 'false',
    ];
    ...
    $form['settings']['navigation_options']['previousText'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $settings['previousText'] ?? '<',
    ];
    ...
    $form['settings']['navigation_options']['nextText'] = [
      ...
      '#description' => $this->t('Text to be used on NEXT navigation button default: ">". HTML allowed.'),
      '#required' => TRUE,
      '#default_value' => $settings['nextText'] ?? '>',
    ];
    ...
    $form['settings']['navigation_options']['textNavigation'] = [
      ...
      '#default_value' => $settings['textNavigation'] ?? 'false',
    ];
    ...
    $form['settings']['navigation_options']['navigationImage'] = [
      ...
      '#default_value' => $settings['navigationImage'] ?? 'false',
    ];
    ...
    $form['settings']['navigation_options']['carouselNavigation'] = [
      ...
      '#default_value' => $settings['carouselNavigation'] ?? 'false',
    ];

    $image_styles_ids = $this->entityTypeManager->getStorage('image_style')
      ->getQuery('AND')
      ->execute();
    ...
    $form['settings']['navigation_options']['carouselNavigationImageStyle'] = [
      ...
      '#default_value' => $settings['carouselNavigationImageStyle'] ?? '',
    ];
    ...
    $form['settings']['navigation_options']['dots'] = [
      ...
      '#default_value' => $settings['dots'] ?? 'true',
    ];
    ...
    $form['settings']['navigation_options']['dotClass'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $settings['dotClass'] ?? 'owl-dot',
    ];
    ...
    $form['settings']['navigation_options']['dotsClass'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $settings['dotsClass'] ?? 'owl-dots',
    ];
    ...
    $form['settings']['transition_options']['animateIn'] = [
      ...
      '#options' => $effects,
      '#default_value' => $settings['animateIn'] ?? 'false',
    ];
    ...
    $form['settings']['transition_options']['animateOut'] = [
      ...
      '#options' => $effects,
      '#default_value' => $settings['animateOut'] ?? 'false',
    ];
    ...
    $form['settings']['transition_options']['mouseDrag'] = [
      ...
      '#default_value' => $settings['mouseDrag'] ?? 'true',
    ];
    ...
    $form['settings']['transition_options']['touchDrag'] = [
      ...
      '#default_value' => $settings['touchDrag'] ?? 'true',
    ];
    ...
    if (is_array($items)) {
      foreach ($items as $key => $item) {
        ...
        if ($item['entity_id']) {
          ...
          $node = $this->entityTypeManager->getStorage('node')->load($item['entity_id']);
  ...
  public function save(array $form, FormStateInterface $form_state) {
      ...
      foreach ($items as $key => $item) {
        foreach ($items_form as $key_form => $item_form) {
          if ($item_form['item_id'] == $item['id']) {
            $items[$key]['weight'] = $item_form['weight'];
            break;
          }
        }
      }
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label OwlCarousel2.', [
          '%label' => $entity->label(),
        ]));
      ...
      default:
        $this->messenger()->addMessage($this->t('Saved the %label OwlCarousel2.', [
          '%label' => $entity->label(),
        ]));
